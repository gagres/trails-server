define({ "api": [
  ...
  {
    "type": "post",
    "url": "/trail/:trailID/realizar",
    "title": "PerformTrail",
    "group": "Trail",
    "description": "<p>O usuário pode realizar uma trilha ja criada por outro</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "userID",
            "description": "<p>ID do usuário que está realizando</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "trailID",
            "description": "<p>ID da trilha realizada</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "trailrat",
            "description": "<p>Avaliação do usuário para a trilha</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "trailtime",
            "description": "<p>Tempo do usuário na trilha</p>"
          }
        ]
      },
      "examples": [
        {
          ...
          "content": "http://localhost:3000/trail/1/realizar?userID=1&trailID=1&trailrat=5&trailtime=02:00:00",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "post",
    "url": "/user/:userID/follow/:priUserID",
    "title": "Follow User",
    "group": "User",
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "Request-Params",
          "content": "http://localhost:3000/user/1/follow/2",
          "type": "json"
        }
      ]
    },
    ...
    "filename": "controllers/user.js",
    "groupTitle": "User",
    "name": "PostUserUseridFollowPriuserid"
  },
  {
    "type": "post",
    "url": "/user/:userID/unfollow/:priUserID",
    "title": "Unfollow User",
    "group": "User",
    "description": "<p>Para de seguir o usuário escolhido</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "priUserID",
            "description": "<p>ID do usuário que deseja parar de seguir</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "Request-Params",
          "content": "http://localhost:3000/user/1/unfollow/2",
          "type": "json"
        }
      ]
    },
    ...
    "filename": "controllers/user.js",
    "groupTitle": "User",
    "name": "PostUserUseridUnfollowPriuserid"
  },
  {
    "type": "post",
    "url": "/users",
